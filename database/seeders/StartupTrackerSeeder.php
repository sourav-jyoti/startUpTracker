...
class StartupTrackerSeeder extends Seeder
{
    ...
    private function seedStartups(): void
    {
        ...
        $neuralink = Startup::factory()->featured()->create([
            ...
            'burn_rate' => 'low', 'total_funding' => 21500000, 'week_number' => 6, 'year' => 2024,
        ]);
        ...
        $this->createStartup('VoltCore', 'voltcore', 'Solid-state battery technology for long-haul EVs.', 2500000, 'seed', 'HIGH GROWTH POTENTIAL', 'Sustainability', 'Munich, DE', 6,
        ...
        $this->createStartup('LedgerFlow', 'ledgerflow', 'Automated reconciliation for crypto-fiat gateways.', 820000, 'pre-seed', 'UNICORN WATCH', 'Fintech', 'London, UK', 6,
        ...
        // Week 7 startups
        $this->createStartup('EcoSystemic', 'ecosystemic', 'Automated carbon footprint tracking for Fortune 500 supply chains.', 12500000, 'series-a', 'LATE STAGE VENTURE', 'Climate Tech', 'San Francisco, US', 7,
        ...
        $this->createStartup('SafeGuard IO', 'safeguard-io', 'Zero-trust network architecture for distributed remote workforces.', 8900000, 'pre-seed', 'HIGH GROWTH POTENTIAL', 'Cybersecurity', 'Austin, US', 7,
        ...
        // Week 8 startups
        $this->createStartup('NeuraLink Analytics', 'neuralink-analytics', 'AI-driven predictive maintenance for renewable energy grids globally.', 4200000, 'seed', 'SERIES A TRENDING', 'AI & ML', 'Stockholm, SE', 8,
